		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Binding Exercise",
									"targetURL": "#sapipstrainingjsonbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingjsonbinding-display": {
								"semanticObject": "sapipstrainingjsonbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.jsonbinding",
									"url": sap.ui.require.toUrl("sapips/training/jsonbinding")
								}
							}
						}
					}
